...
export const RightSidebar: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 overflow-hidden" style={{ paddingLeft: '50px', paddingRight: '50px' }}>
      {/* Source Image */}
        ...
        {activeTab === 'settings' && (
          <div className="px-4 py-4 space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500">Algomodo v1.0.0</p>
            </div>
          </div>
        )}
      </div>
