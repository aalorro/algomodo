...
const useCases = [
  {
    title: '1. Album Covers & Music Visuals',
  ...
  {
    title: '2. Textile & Surface Pattern Design',
  ...
  {
    title: '3. Game & Film Asset Generation',
  ...
  {
    title: '4. Data Visualization & Infographics',
  ...
  {
    title: '5. Branding & Identity Design',
  ...
  {
    title: '6. Print Art & Gallery Work',
  ...
  {
    title: '7. Educational & Scientific Illustration',
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl max-w-2xl w-full max-h-[85vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-5 text-sm text-gray-700 dark:text-gray-300">
          <p className="text-xs text-gray-400 dark:text-gray-500">
            Algorithmic art is a practical tool across creative and technical fields. Here are eight ways people use generators like Algomodo.
          </p>
